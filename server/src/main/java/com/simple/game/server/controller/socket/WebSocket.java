...
import com.simple.game.server.common.utils.CurPool;
import com.simple.game.server.common.utils.JsonUtils;
import com.simple.game.server.common.utils.SpringContextUtil;
...
@Component
@ServerEndpoint("/websocket/{gameCode}/{sessionId}")
//此注解相当于设置访问URL
